...
import type {ImageService, SSRImageService, TransformOptions} from './loaders/index'
...
const UNSUPPORTED_ADAPTERS = new Set(['@astrojs/cloudflare', '@astrojs/netlify/edge-functions', '@astrojs/vercel/edge'])
